...
<div class="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div class="bg-green-50 rounded-xl p-6 mb-8 relative overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 relative z-10 pl-20 pr-10">
            <div class="ml-8"> <!-- Added ml-8 for additional right shift -->
                <h1 class="text-2xl font-bold text-blue-900">Welcome, <?php echo e(auth()->user()->name); ?>!</h1>
                <p class="text-gray-600 mt-1">Hey reserve your spot before someone else's does</p>
            </div>
            <a href="<?php echo e(route('reservations.create')); ?>" class="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-full transition duration-150 ease-in-out shadow-sm hover:shadow-md">
 ...
 <div class="bg-blue-400 text-white p-4 rounded-lg flex items-center">
    ...
    <a href="<?php echo e(route('reservations.create')); ?>" class="inline-flex items-center px-3 py-1 bg-white text-blue-600 font-medium rounded-full text-m shadow-sm hover:bg-gray-100 transition duration-150 ease-in-out">
        Book a seat now
    </a>
</div>
    <?php else: ?>
                        ...
                        <tr class="hover:bg-blue-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="text-m font-medium text-gray-900"><?php echo e($reservationDate->format('D, M j, Y')); ?></div>
                                    <?php if($isToday): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-m leading-5 font-semibold rounded-full bg-gray-100 text-gray-800"><?php echo e($reservation->seat->seat_number); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-m text-gray-500"><?php echo e($reservation->seat->location); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-m leading-5 font-semibold rounded-full <?php echo e($reservation->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-m font-medium">
                                ...
                                <form action="<?php echo e(route('reservations.destroy', $reservation)); ?>" method="POST" class="inline-block" id="cancel-form-<?php echo e($reservation->id); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="button" onclick="confirmCancel('<?php echo e($reservation->id); ?>')" class="text-red-600 hover:text-red-900 inline-flex items-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\Seat\3\seat-reservation-system\resources\views/intern/dashboard.blade.php ENDPATH**/ ?>