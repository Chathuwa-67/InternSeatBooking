...
<nav class="bg-[#00204F] text-white px-4 py-3" x-data="{ mobileMenuOpen: false, userDropdownOpen: false }">
  <div class="flex flex-col md:flex-row justify-between items-center gap-4">
    ...
    <div class="w-full md:w-auto flex justify-between items-center">
      <a href="<?php echo e(auth()->check() ? (auth()->user()->isAdmin() ? route('admin.dashboard') : route('dashboard')) : '/'); ?>" class="flex items-center gap-3">
    ...
    >
      ...
      <ul class="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-4 text-sm md:text-base py-4 md:py-0">
        <?php if(auth()->user()->isAdmin()): ?>
          <li>
            <a 
              ...
              class="flex items-center gap-2 px-3 py-2 relative
                <?php echo e(request()->is('admin/dashboard') 
          ...
          <li>
            <a 
              href="<?php echo e(route('admin.seats.index')); ?>" 
              class="flex items-center gap-2 px-3 py-2 relative
                <?php echo e(request()->is('admin/seats*') 
                   ? 'text-green-400 font-semibold' 
                   : 'text-white hover:text-white after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-green-400 after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100'); ?>">
          ...
          <li>
            <a 
              ...
              class="flex items-center gap-2 px-3 py-2 relative
                <?php echo e(request()->is('admin/reservations*') 
                   ? 'text-green-400 font-semibold' 
                   : 'text-white hover:text-white after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-green-400 after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100'); ?>">
          ...
          <li>
            <a 
              ...
              class="flex items-center gap-2 px-3 py-2 relative
                <?php echo e(request()->is('admin/reports') 
                   ? 'text-green-400 font-semibold' 
                   : 'text-white hover:text-white after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-green-400 after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100'); ?>">
        ...
        <?php else: ?>
          ...
          <li>
            <a 
              ...
              class="flex items-center gap-2 px-3 py-2 relative
                <?php echo e(request()->is('reservations') 
                   ? 'text-green-400 font-semibold' 
                   : 'text-white hover:text-white after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-green-400 after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100'); ?>">
          ...
          <li>
            <a 
              ...
              class="flex items-center gap-2 px-3 py-2 relative
                <?php echo e(request()->is('reservations/create') 
                   ? 'text-green-400 font-semibold' 
                   : 'text-white hover:text-white after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-green-400 after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100'); ?>">
      ...
      <ul class="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-4 text-sm md:text-base py-4 md:py-0">
        ...
        <li>
          <a 
            ...
            class="flex items-center gap-2 px-3 py-2 relative
              <?php echo e(request()->is('register') 
                 ? 'text-green-400 font-semibold' 
                 : 'text-white hover:text-white after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-green-400 after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100'); ?>">
...
</nav><?php /**PATH C:\Users\Administrator\Desktop\Seat\3\seat-reservation-system\resources\views/partials/navbar.blade.php ENDPATH**/ ?>