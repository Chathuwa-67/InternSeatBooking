    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 relative z-10 pl-24">
        <div>
             <h1 class="text-2xl font-bold text-blue-900">Manage My Reservations</h1>
                <p class="text-gray-600 mt-1"><?php echo e(explode(' ', auth()->user()->name)[0]); ?> Seats are like cookies - they disappear fast</p>
        </div>
    ...
    ?>
                    <tr class="hover:bg-blue-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <?php if($isPassed && $status !== 'cancelled'): ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            ?>
                            <span class="px-2 inline-flex text-m leading-5 font-semibold rounded-full <?php echo e($statusClasses[$status] ?? 'bg-gray-100 text-gray-800'); ?>">
                                <?php echo e(ucfirst($status)); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <?php if($status === 'actively ongoing' || $status === 'active'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\Seat\3\seat-reservation-system\resources\views/intern/reservations/index.blade.php ENDPATH**/ ?>